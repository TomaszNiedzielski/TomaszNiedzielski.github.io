...
const Header: React.FC<Props> = ({ title, minimize, headerAvatar }) => {
    return (
        <header className="chat-header">
            ...
            <img src={minimizeIcon} alt="minimize" className="chat-header__minimize" onClick={minimize} />
        </header>
    );
}
