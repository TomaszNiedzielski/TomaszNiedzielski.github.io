    ...
    return (
        <div className="chat-input">
            <input
                ...
                ref={el}
            />
            {value.length > 0 && <img src={sendIcon} alt="send" onClick={send} />}
        </div>
    );
}
